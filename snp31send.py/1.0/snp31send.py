...
def printHelpPage():
    ...
    print "Options: (F) means FORWARD, (N) NOTIFY, (R) register, (S) subscribe"
...
if action != "NOTIFY" and action != "REGISTER" and action != "SUBSCRIBE" and action != "FORWARD":
