...
o Not all SNP 3.1 requests are handled by this server, in fact only NOTIFY and FORWARD are

o This server does not implement the SNPD discovery service (yet)
